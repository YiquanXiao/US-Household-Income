...
create table ushouseholdincome_backup like ushouseholdincome;
insert into ushouseholdincome_backup select * from ushouseholdincome;
create table ushouseholdincome_statistics_backup like ushouseholdincome_statistics;
insert into ushouseholdincome_statistics_backup select * from ushouseholdincome_statistics;
...
# checkj State_Name for ushouseholdincome_statistics
select State_Name, count(State_Name)  # select distinct State_Name
from ushouseholdincome_statistics
group by State_Name
order by State_Name
